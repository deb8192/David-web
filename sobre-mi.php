<?php
    ...
    $keywords = "sobre mi, david, valls, david valls, actor, informacion personal, trayectoria, historia";
    $description = "P&aacute;gina de información personal sobre la trayectoria de David Valls";
