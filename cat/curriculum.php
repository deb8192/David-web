<?php
    ...
    $keywords = "curriculum, david, valls, david valls, actor, cv, curriculum vitae, vitae, experiencia, educacio, formacio academica";
    $description = "P&agrave;gina amb el Curriculum de David Valls";
