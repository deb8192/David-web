<?php
    ...
    $title = "Videobook";
    $keywords = "videobook, david, valls, david valls, actor, experiencia, video, visual, trajectoria, curriculum";
    $description = "P&agrave;gina amb el videobook de David Valls";
