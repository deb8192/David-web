<?php
    ...
    $title = "Sobre mi";
    $keywords = "Sobre mi, david, valls, david valls, actor, informacio personal, trajectoria, historia";
    $description = "P&agrave;gina d'informaci&oacute; personal sobre la trajectoria de David Valls";
